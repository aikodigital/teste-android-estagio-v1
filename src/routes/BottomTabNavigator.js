...
const Tab = createBottomTabNavigator(); // Criação do menu bottom
const Stack = createStackNavigator(); // Criação do menu drawer
...
// Rotas que serão exibidas no menu inferior
