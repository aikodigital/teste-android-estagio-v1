      ...
      <View>
        ...
        <View className="flex flex-row justify-around pt-6">
          <TouchableWithoutFeedback onPress={()=> setRowOrSearch("linhas")}>
            <Text className={`text-xl px-4 py-1 rounded-md ${ rowOrSearch  === "linhas" ? "bg-greenPrimary text-[#fff] font-semibold" : "bg-transparent text-bluePrimary"}`}>Linhas</Text>
          </TouchableWithoutFeedback >
          <TouchableWithoutFeedback onPress={()=> setRowOrSearch("rotas")}>
            <Text  className={`text-xl px-4 py-1 rounded-md ${ rowOrSearch  === "rotas" ? "bg-greenPrimary text-[#fff] font-semibold" : "bg-transparent text-bluePrimary"}`}>Rotas</Text>
          </TouchableWithoutFeedback>
        </View> 
